...
public class FixtureExecucaoProva {
	
	public static ExecucaoProva criaCenario01() {
		
		ExecucaoProva execucao = new ExecucaoProva();
	...
	private static Prova criaProva() {
	...
	private static Questao questao1(NivelDificuldade muitoDificil,
	...
	private static Questao questao2(NivelDificuldade nivelDificuldade,
	...
	private static Questao questao3(NivelDificuldade nivelDificuldade,
			AreaConhecimento area, Assunto assunto) {
		Questao q1 = new Questao();
		q1.setId(3l);
	...
	private  static Questao questao4(NivelDificuldade nivelDificuldade,
			AreaConhecimento area, Assunto assunto) {
		Questao q1 = new Questao();
		q1.setId(4l);
		q1.setTipoQuestao(TipoQuestao.ESCOLHA_UNICA);
	...
	private static  Questao questao5(NivelDificuldade nivelDificuldade,
			AreaConhecimento area, Assunto assunto) {
		Questao q1 = new Questao();
		q1.setId(5l);
		q1.setTipoQuestao(TipoQuestao.ESCOLHA_UNICA);
	...
	public static ExecucaoProva criaCenario02() {
		...
		Candidato c = new Candidato();
		c.setCpf("24317174707");
		c.setNome("Fernanda Postai");
		...
		resposta3.setQuestao(aux);
		List<AlternativaQuestao> resp3 = new ArrayList<AlternativaQuestao>();
		aux.getGabarito().forEach(gabarito -> {
			resp3.add(gabarito);
		});
		resposta3.setRespostas(resp3);
	...
	public static ExecucaoProva criaCenario03() {
